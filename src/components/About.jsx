      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            I'm a pre-final year student. Currently pursuing B.Tech. in Computer
            Engineering from Dharmsinh Desai University, Nadiad. I'm a
            Full-Stack Dev. enthusiasist working with MERN Stack. I am
